...
var SelectComponent = SelectComponent_1 = (function () {
    ...
    Object.defineProperty(SelectComponent.prototype, "items", {
        set: function (value) {
            ...
            if (!value) {
                ...
                this.itemObjects = this._items.map(function (item) { return (typeof item === 'string' ? new select_item_1.SelectItem(item) : new select_item_1.SelectItem({ id: item[_this.idField], disabled: item[_this.disableField], text: item[_this.textField], children: item[_this.childrenField] })); });
            }
        },
        enumerable: true,
        configurable: true
    ...
    SelectComponent.prototype.isDisabled = function (value) {
...
__decorate([
    core_1.Input(),
    __metadata("design:type", String)
], SelectComponent.prototype, "disableField", void 0);
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean)
